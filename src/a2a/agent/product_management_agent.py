...
from agent_framework import AgentThread, ChatAgent, BaseChatClient, ChatResponse, ai_function
...
class AgentFrameworkProductManagementAgent:
    ...
    def __init__(self):
        ...
        self.agent = ChatAgent(
            ...
            instructions=(
                ...
                'The status field must be one of: "input_required", "completed", or "error".\n'
                'The message field should contain your helpful response to the user.\n'
    ...
    def _get_agent_response(
        ...
        try:
            ...
            # If JSON parsing fails, wrap the plain text response
            logger.warning(f"Failed to parse JSON response, using plain text: {e}")
            return {
